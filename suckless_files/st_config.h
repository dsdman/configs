 ...
 */
char font[] = "Deja Vu Sans Mono for Powerline:pixelsize=16:antialias=true:autohint=true";
int borderpx = 1;
...
/* binding TERMMOD + E to open contents of terminal in vim */

/*static char *openinvim[] = { "/bin/sh", "-c",
    "nvim", "externalpipe", winid, NULL };*/

static char *openinvim[] = { "/bin/sh", "-c",
    "nvim -c 'startinsert'", "externalpipe", winid, NULL };
